...
def main():
    ...
    parser.add_argument('--long_length',
                        type=int,
                        help="Minutes of the length of the flight")
    parser.add_argument('--long_minutes_ground_time',
                        type=int,
                        help="Minutes of ground time between the long flight")
    parser.add_argument('--long_minutes_tat',
                        type=int,
                        help="Minutes of ground time between the long flight")
...
def gannt(solution):
    ...
    for flight in solution.flights:
        flight_data = [
            "Aircraft " + str(flight.assigned_aircraft),
            datetime.datetime.fromtimestamp(flight.start_date),
            datetime.datetime.fromtimestamp(flight.end_date),
